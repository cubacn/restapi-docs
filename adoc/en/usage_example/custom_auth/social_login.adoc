...
The mechanism of social login can be used in REST API too. The complete sample application is available on https://github.com/cuba-platform/sample-social-login/[GitHub] and described in the {manual}/social_login.html[social login] section, below are the key points of getting an access token with a Facebook account.
